...
fun main(): Unit = runBlocking {
    ...
    val registrationRequestQueue = RabbitQueue(System.getenv("REGISTRATION_REQUEST_QUEUE_NAME")?.toString() ?: "registration-request")
    // TODO - read the routing key from the environment
    connectionFactory.declareAndBind(exchange = registrationRequestExchange, queue = registrationRequestQueue, routingKey = System.getenv("REGISTRATION_REQUEST_QUEUE_ROUTING_KEY").toString() ?: "42")
